# RailsAdmin config file. Generated on November 27, 2013 08:52
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Bootstrap App', 'Admin']
  ...
  # config.excluded_models = ['Identity', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Identity', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your identity.rb model definition
